  ...
  <div class="bio-box">
    ...
    <h3 class="bio-box__title">'Xcode</h3>
    <p class="bio-box__subtitle">Programer Dev</p>
    <br />
    <p class="bio-box__bio">1987/07/29</p>
    <br />
    <p class="bio-box__bio">INTP</p>
    <br />
    <p class="bio-box__bio">Eng / ID</p>
